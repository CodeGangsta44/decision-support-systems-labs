...
import edu.kpi.ip71.dovhopoliuk.cp1.binary.relations.predicate.connectivity.ConnexPredicate;
import edu.kpi.ip71.dovhopoliuk.cp1.binary.relations.predicate.cycle.AcyclicPredicate;
...
import edu.kpi.ip71.dovhopoliuk.cp1.binary.relations.predicate.symmetry.AsymmetricPredicate;
import edu.kpi.ip71.dovhopoliuk.cp1.binary.relations.predicate.symmetry.SymmetricPredicate;
import edu.kpi.ip71.dovhopoliuk.cp1.binary.relations.predicate.transitivity.NegativelyTransitivePredicate;
import edu.kpi.ip71.dovhopoliuk.cp1.binary.relations.predicate.transitivity.TransitivePredicate;
