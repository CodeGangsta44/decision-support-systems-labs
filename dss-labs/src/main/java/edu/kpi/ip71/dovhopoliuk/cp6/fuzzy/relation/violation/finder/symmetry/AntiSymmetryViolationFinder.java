package edu.kpi.ip71.dovhopoliuk.cp6.fuzzy.relation.violation.finder.symmetry;
...
public class AntiSymmetryViolationFinder implements BiFunction<FuzzyRelation, FuzzyRelationProperty, FuzzyRelationPropertyViolation> {
    ...
    private List<String> findViolations(final FuzzyRelation fuzzyRelation) {
        ...
        return IntStream.range(INTEGER_ZERO, fuzzyRelation.getSize())
                ...
                .flatMap(rowIndex -> IntStream.range(INTEGER_ZERO, fuzzyRelation.getSize())
                        ...
                        .filter(columnIndex -> DOUBLE_ZERO != Math.min(fuzzyRelation.getElement(rowIndex, columnIndex),
